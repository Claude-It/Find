...
interface LandingProps {
  /** Reopen the "own your design" picker (the in-app settings entry point). */
  onOpenSettings?: () => void;
}

export function LiquidLanding({ onOpenSettings }: LandingProps) {
  return (
...
function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-32 pb-24 px-6 overflow-hidden grain">
      {/* Liquid glass morphism background */}
      <div className="absolute inset-0 -z-10">
        <div
          className="absolute top-[10%] left-[5%] w-[60vw] h-[60vw] max-w-[720px] max-h-[720px] rounded-full blob-a"
          style={{
            background: "radial-gradient(circle, oklch(0.82 0.17 70 / 0.7), transparent 65%)",
            filter: "blur(80px)",
          }}
        />
        <div
          className="absolute top-[20%] right-[0%] w-[55vw] h-[55vw] max-w-[700px] max-h-[700px] rounded-full blob-b"
          style={{
            background: "radial-gradient(circle, oklch(0.84 0.13 165 / 0.55), transparent 65%)",
            filter: "blur(90px)",
          }}
        />
        <div
          className="absolute bottom-[-10%] left-[30%] w-[50vw] h-[50vw] max-w-[600px] max-h-[600px] rounded-full blob-c"
          style={{
            background: "radial-gradient(circle, oklch(0.72 0.16 295 / 0.55), transparent 65%)",
            filter: "blur(85px)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 120% 90% at 50% 40%, transparent 30%, var(--background) 100%)",
          }}
        />
      </div>
        ...
        <Reveal delay={0.6}>
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.20 0.014 60 / 0.9), oklch(0.18 0.014 60 / 0.6))",
              }}
            >
...
function CTA() {
  ...
  return (
    <section className="px-6 py-32">
      <Reveal>
        <div className="mx-auto max-w-6xl glass-panel rounded-[2.5rem] p-16 md:p-24 text-center relative overflow-hidden grain">
          <div
            className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[700px] rounded-full blob-a"
            style={{
              background: "radial-gradient(circle, oklch(0.82 0.17 70 / 0.35), transparent 60%)",
              filter: "blur(60px)",
            }}
          />
